...
?>
	<form method="post"><br>
	<h1><center>Online Examination System - Admin Login</center></h1><br><br><br>
<div class="container">	
...
<a href="first.php"><button type="button" style="background-color:#f44336;float:left;">Cancel</button></a>
